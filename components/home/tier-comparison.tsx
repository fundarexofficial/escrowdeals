      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <Card className="border-slate-800 bg-slate-900/50 backdrop-blur relative overflow-hidden">
            ...
            <CardHeader>
              <CardTitle className="text-2xl text-white">{t.tiers.tier1Title}</CardTitle>
              <CardDescription className="text-slate-400">{t.tiers.tier1Desc}</CardDescription>
              <div className="pt-4">
                <span className="text-4xl font-bold text-white">$200</span>
                <span className="text-slate-400 ml-2">- $300</span>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <Link href="/accounts?tier=Tier1" className="block">
                <Button className="w-full bg-slate-800 hover:bg-slate-700 text-white">{t.tiers.viewAccounts}</Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="border-cyan-500/30 bg-slate-900/50 backdrop-blur relative overflow-hidden">
            ...
            <CardHeader>
              <CardTitle className="text-2xl text-white">{t.tiers.tier2Title}</CardTitle>
              <CardDescription className="text-slate-400">{t.tiers.tier2Desc}</CardDescription>
              <div className="pt-4">
                <span className="text-4xl font-bold text-white">$600</span>
                <span className="text-slate-400 ml-2">- $800+</span>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              <ul className="space-y-3">
              ...
              <Link href="https://t.me/Fundarex" target="_self">
